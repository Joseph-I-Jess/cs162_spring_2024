...
class GuiBasics:
    ...
    def __init__(self):
        ...
        self.entry.bind("<Up>", lambda event: self.move(y=-1))
        self.entry.bind("<Down>", lambda event: self.move(y=1))
        self.entry.bind("<Right>", lambda event: self.move(x=1))
        self.entry.bind("<Left>", lambda event: self.move(x=-1))
